...
applicability: Guardrails should be applied to any ML system whose outputs are consequential — autonomous actions, user-facing content, financial decisions, or safety-critical inference.
